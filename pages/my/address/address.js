        ...
        if (this.data.consignee_no === '') {
            __USER__
                .addNewConsignee(
                    ...
                    this.data.receiver, this.data.mobile, this.data.address, this.data.postcode)
                .then(() => {
                    wx.navigateBack();
                });
        } else {
            __USER__
                .editConsignee(
                    encodeURIComponent(__CRYPT__.encryptData('')),
                    this.data.consignee_no, this.data.receiver, this.data.mobile, this.data.address, this.data.postcode)
                .then(() => {
                    wx.navigateBack();
                });
        }
